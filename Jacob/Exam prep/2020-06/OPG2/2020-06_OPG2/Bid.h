...
public:
    ...
    Bid(Buyer* b, Plot* p, double price, int priority) { mBuyer = b; mPlot = p; mPrice = price; mPriority = priority; }
    ...
    // Implementer en sammenligningsoperator mindre end som sammenligner på baggrund af prioritet
